    ...
    def set_name(self):
      ...
      while result is None: 
        ...
        if len(input_value) == 0:
          input_value = input("Input cannot be empty. Please enter a string: ")
          continue

        if not input_value.isalnum():
          #checking input
          input_value = input("Input cannot be non-alphanumeric. Please enter a string: ")
          continue
        else:
          #Value is okay
          result = input_value 
    ...
    def set_symbol(self):
      ...
      #Testing if Input okay
        ...
        if not input_value.isalpha():
          #checking input
          input_value = input("Input cannot be non-alpha. Please enter a single letter: ")
          continue
        else:
          #Value is okay
          result = input_value
